...
public class AppealController {
	...
	@GetMapping("/findAppealByOrderId")
	@ResponseBody
	public Result findAppealByOrderId(String orderId) {
		UserAccountDetails user = (UserAccountDetails) SecurityContextHolder.getContext().getAuthentication()
				.getPrincipal();
		return Result.success().setData(appealService.findAppealByOrderId(user.getUsername(), orderId));
	}

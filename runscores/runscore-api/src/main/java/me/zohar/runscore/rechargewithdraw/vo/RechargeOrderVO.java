...
public class RechargeOrderVO {
	...
	public static RechargeOrderVO convertFor(RechargeOrder rechargeOrder) {
		...
		if (rechargeOrder.getPayChannel() != null) {
			...
			vo.setVirtualWalletAddr(rechargeOrder.getPayChannel().getVirtualWalletAddr());
			vo.setPayee(rechargeOrder.getPayChannel().getPayee());
			vo.setGatheringCodeStorageId(rechargeOrder.getPayChannel().getGatheringCodeStorageId());
		}

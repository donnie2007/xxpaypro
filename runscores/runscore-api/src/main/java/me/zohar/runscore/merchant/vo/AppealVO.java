	...
	public static AppealVO convertFor(Appeal appeal) {
		...
		if (appeal.getMerchantOrder() != null) {
			...
			if (appeal.getMerchantOrder().getMerchant() != null) {
				vo.setMerchantName(appeal.getMerchantOrder().getMerchant().getMerchantName());
				vo.setGatheringChannelName(appeal.getMerchantOrder().getGatheringChannel().getChannelName());
			}
			if (appeal.getMerchantOrder().getPayInfo() != null) {
				vo.setAttch(appeal.getMerchantOrder().getPayInfo().getAttch());
			}
